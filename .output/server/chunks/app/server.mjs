import { version, ref, watchEffect, watch, getCurrentInstance, hasInjectionContext, inject, defineComponent, h, Suspense, nextTick, Transition, unref, provide, shallowReactive, useSSRContext, createApp, reactive, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, toRef, shallowRef, isReadonly, defineAsyncComponent, isRef, isShallow, isReactive, toRaw, withCtx, mergeProps, computed } from 'vue';
import Rt from 'node:http';
import Ka from 'node:https';
import { o as le, W as Wn, T as Ti, p as destr, f as useRuntimeConfig$1, q as defu } from '../nitro/node-server.mjs';
    ...
    children: [
      {
        ...
        alias: [],
        redirect: void 0,
        component: () => import('./_nuxt/_lessonslug_-53687b19.mjs').then((m) => m.default || m)
      }
    ],
    meta: {},
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/course-0bd2eca7.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-4e773e81.mjs').then((m) => m.default || m)
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-404-3bacd15c.mjs').then((r) => r.default || r));
    const _Error = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-500-648fc2f2.mjs').then((r) => r.default || r));
...
export { __nuxt_component_1 as _, _export_sfc as a, useHead as b, useRouter as c, parseQuery as d, withoutTrailingSlash as e, createError as f, hasProtocol as h, navigateTo as n, parseURL as p, server as s, useRoute as u, withTrailingSlash as w };
